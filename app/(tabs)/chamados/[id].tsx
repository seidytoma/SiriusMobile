        ...
        {activeTab === 'detalhes' ? (
          ...
          >
            ...
            <View style={[
              ...
              />
              <TouchableOpacity onPress={handleSendMessage} style={[styles.sendBtn, (!newMessage.trim() || sendingMsg) && { opacity: 0.5 }]} disabled={!newMessage.trim() || sendingMsg} accessibilityRole="button" accessibilityLabel="Enviar mensagem" accessibilityState={{ disabled: !newMessage.trim() || sendingMsg }}>
                {sendingMsg ? (
