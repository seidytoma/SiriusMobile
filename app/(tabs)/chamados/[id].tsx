          ...
          >
            ...
            <View style={[
              ...
              <TouchableOpacity
                ...
                style={[styles.sendBtn, (sendingMsg || newMessage.trim().length === 0) && { opacity: 0.5 }]}
                disabled={sendingMsg || newMessage.trim().length === 0}
                accessibilityRole="button"
                accessibilityLabel="Enviar mensagem"
                accessibilityState={{ disabled: sendingMsg || newMessage.trim().length === 0 }}
              >
                {sendingMsg ? (
